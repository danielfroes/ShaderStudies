Shader "Tutorial/001-004_Basic_Unlit"{
  ...
  SubShader{
    ...
    Pass{
      ...
      {
        v2f o;
        //convert the vertex position from object to clip Space so they can be rendered correctly
        o.position = UnityObjectToClipPos(v.vertex);
        //apply the texture trasnform to the UV coordinate and paass them to hte v2f struct
      ...
      fixed4 frag(v2f i): SV_TARGET
      {
        ...
        //multiply the texzture color and tint color
        col *= _Color;
